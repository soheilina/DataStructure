...
std::shared_ptr<std::pair<std::shared_ptr<Vertex>&, std::shared_ptr<Vertex>&>> Edge::getVertecies()
{
	...
	std::shared_ptr <std::pair< std::shared_ptr<Vertex>&, std::shared_ptr<Vertex>&>> vPtr{ std::make_shared<std::pair< std::shared_ptr<Vertex>&, std::shared_ptr<Vertex>&>>(m_rightVertex, m_leftVertex) };
	return  vPtr;
}